...
class DeskletsViewSidePage(SidePage):
    ...
    def load(self, window):
        ...
        settings.add_row(GSettingsSwitch(_("Alternate left and right positioning"), "org.cinnamon", "desklet-alternate-side"))
        settings.add_reveal_row(GSettingsSpinButton(_("Interval in minutes between swap"), "org.cinnamon", "desklet-alternate-side-interval", "", 1, 200, 1, 5), "org.cinnamon", "desklet-alternate-side")
